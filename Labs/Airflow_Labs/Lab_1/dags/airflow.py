...
with DAG(
    ...
    description='DAG example with validation task for Lab 1',
    catchup=False,
) as dag:
    ...
    build_save_model_task = PythonOperator(
        ...
        op_args=[data_preprocessing_task.output, "modelOutput.sav"],
    )
    ...
    load_model_task = PythonOperator(
        ...
        op_args=["modelOutput.sav", build_save_model_task.output],
    )
